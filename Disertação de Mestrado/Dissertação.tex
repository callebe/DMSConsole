...
\usepackage[pdftex,linktocpage=true,pdfauthor={Callebe Soares Barbosa},pdftitle={Console Touchscreen Para Indicadores de Destino},pdfsubject={Dissertação de Mestrado}]{hyperref}
...
\chapter{Indicadores de Destino}
